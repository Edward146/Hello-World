...
int highest_number = 250;
long evenHigher = 7500;
float backwordsCounting = 0.1;
double wayBack = 0.0;
//
...
println("Starting Variable is", evenHigher); //Returns 0
evenHigher = highest_number +=25; // Returns Baker's Dozen,
